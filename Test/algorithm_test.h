...
#include "../MyTinySTL/cc_Containers/vector.h"
#include "test.h"
...
#pragma warning(disable : 4389)
        ...
        namespace algorithm_test
        {
            ...
            TEST(equal_test) {
                ...
                EXPECT_EQ(std::equal(v1.begin(), v1.end(), arr1), mystl::equal(v1.begin(), v1.end(), arr1));
            ...
            TEST(accumulate_test) {
                int arr1[] = {1, 2, 3, 4, 5};
                EXPECT_EQ(std::accumulate(arr1, arr1 + 5, 0), mystl::accumulate(arr1, arr1 + 5, 0));
                EXPECT_EQ(std::accumulate(arr1, arr1 + 5, 5), mystl::accumulate(arr1, arr1 + 5, 5));
            ...
            TEST(inner_product_test) {
                ...
                int arr2[] = {2, 2, 2, 2, 2};
                int arr3[] = {1, 2, 3, 4, 5};
                EXPECT_EQ(std::inner_product(arr1, arr1 + 5, arr3, 0), mystl::inner_product(arr1, arr1 + 5, arr3, 0));
            ...
            TEST(adjacent_find_test) {
                int arr1[] = {1, 2, 3, 3, 4};
                int arr2[] = {1, 2, 3, 4, 5};
                EXPECT_EQ(std::adjacent_find(arr1, arr1 + 5), mystl::adjacent_find(arr1, arr1 + 5));
                EXPECT_EQ(std::adjacent_find(arr2, arr2 + 5), mystl::adjacent_find(arr2, arr2 + 5));
            ...
            TEST(all_of_test) {
                int arr1[] = {1, 3, 5, 7, 9};
                int arr2[] = {1, 3, 5, 7, 8};
                EXPECT_EQ(std::all_of(arr1, arr1 + 5, is_odd), mystl::all_of(arr1, arr1 + 5, is_odd));
                EXPECT_EQ(std::all_of(arr2, arr2 + 5, is_odd), mystl::all_of(arr2, arr2 + 5, is_odd));
            }

            TEST(any_of_test) {
                int arr1[] = {1, 2, 4, 6, 8};
                int arr2[] = {2, 4, 6, 8, 10};
                EXPECT_EQ(std::any_of(arr1, arr1 + 5, is_odd), mystl::any_of(arr1, arr1 + 5, is_odd));
                EXPECT_EQ(std::any_of(arr2, arr2 + 5, is_odd), mystl::any_of(arr2, arr2 + 5, is_odd));
            }

            TEST(binary_search_test) {
                int arr1[] = {1, 2, 3, 4, 5};
                EXPECT_EQ(std::binary_search(arr1, arr1 + 5, 1), mystl::binary_search(arr1, arr1 + 5, 1));
                EXPECT_EQ(std::binary_search(arr1, arr1 + 5, 6), mystl::binary_search(arr1, arr1 + 5, 6));
            }
            ...
            TEST(count_if_test) {
                int arr1[] = {1, 2, 2, 3, 3, 3, 4, 5, 8};
                EXPECT_EQ(std::count_if(arr1, arr1 + 9, is_odd), mystl::count_if(arr1, arr1 + 9, is_odd));
                EXPECT_EQ(std::count_if(arr1, arr1 + 9, is_even), mystl::count_if(arr1, arr1 + 9, is_even));
            }
            ...
            TEST(none_of_test) {
                ...
                int arr2[] = {1, 3, 5, 7, 8};
                int arr3[] = {2, 4, 6, 8, 10};
                EXPECT_EQ(std::none_of(arr1, arr1 + 5, is_even), mystl::none_of(arr1, arr1 + 5, is_even));
                EXPECT_EQ(std::none_of(arr2, arr2 + 5, is_even), mystl::none_of(arr2, arr2 + 5, is_even));
                EXPECT_EQ(std::none_of(arr3, arr3 + 5, is_even), mystl::none_of(arr3, arr3 + 5, is_even));
            }
            ...
            TEST(upper_bound_test) {
                ...
                EXPECT_EQ(std::upper_bound(arr1, arr1 + 9, 0), mystl::upper_bound(arr1, arr1 + 9, 0));
                EXPECT_EQ(std::upper_bound(arr1, arr1 + 9, 1), mystl::upper_bound(arr1, arr1 + 9, 1));
                EXPECT_EQ(std::upper_bound(arr1, arr1 + 9, 3), mystl::upper_bound(arr1, arr1 + 9, 3));
